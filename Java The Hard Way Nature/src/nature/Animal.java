...
/*
1. There are getters for age, trait1, and trait2, but not setters. Design-wise, why do you think that is?
 *The traits will never need to change, as they are only assigned once, at the time of creation (or birth).
2. What is the purpose of the while loops in lines 30 and 47?
 *The while loops make sure trait1 and trait2 are never the same trait.
*/
